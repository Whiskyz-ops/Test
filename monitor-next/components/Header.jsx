...
function Chip({ children, tone = "teal" }) {
  const bg = tone === "teal" ? "linear-gradient(135deg,#2dd4bf,#34d399)" : "#12151f";
  const fg = tone === "teal" ? "#04120f" : "#f3f4f8";
  return (
    <span className="inline-flex items-center justify-center align-middle mx-1.5 w-11 h-9 rounded-2xl text-[16px] translate-y-[-2px] shadow-[0_6px_20px_-6px_rgba(45,212,191,0.6)]"
