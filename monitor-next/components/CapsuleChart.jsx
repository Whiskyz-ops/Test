              ...
              {data.map((r, i) => {
                ...
                return (
                  <div key={i} className="relative flex-1 flex flex-col justify-end items-center" onMouseEnter={() => setHover(i)}>
                    ...
                    {showTag && (
                      <div className="absolute -top-1 z-10 px-2 py-1 rounded-lg text-[10px] font-bold whitespace-nowrap shadow-cardhover" style={{ background: "#000000", border: "1px solid rgba(255,255,255,0.12)" }}>
